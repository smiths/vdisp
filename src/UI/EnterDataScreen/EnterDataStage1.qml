...
Rectangle {
    ...
    JuliaSignals {
        ...
        onInputFileAccepted: {
            ...
            unitsDropdown.currentIndex = units
    ...
    ComboBox {
        ...
        width: 100 + 100 * (vdispWindow.width-vdispWindow.minimumWidth)/(vdispWindow.maximumWidth-vdispWindow.minimumWidth)
        height: 30
        font.pixelSize: 18
